    ...
    <section className="relative min-h-[700px] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-24 relative z-30">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 relative z-30">
            <div className="hover:scale-105 transition-transform duration-300 relative z-30">
              <Button
                asChild
                size="lg"
                className="bg-destructive text-white hover:bg-destructive/90 gap-2 min-w-[220px] h-14 text-lg font-semibold shadow-2xl btn-glow relative z-30 pointer-events-auto"
              >
                <Link href="/plainte" className="relative z-30">
            ...
            <div className="relative z-30 pointer-events-auto">
              <Button
                ...
                size="lg"
                variant="outline"
                className="bg-white/10 backdrop-blur-sm border-2 border-white text-white hover:bg-white hover:text-primary gap-2 min-w-[220px] h-14 text-lg font-semibold transition-all duration-300 relative z-30"
              >
                <Link href="/suivi" className="relative z-30">
            ...
            <div className="relative z-30 pointer-events-auto">
              <Button
                ...
                className="bg-white/10 backdrop-blur-sm border-2 border-white text-white hover:bg-white hover:text-primary gap-2 min-w-[220px] h-14 text-lg font-semibold transition-all duration-300 relative z-30"
              >
                <Link href="/chatbot" className="relative z-30">
